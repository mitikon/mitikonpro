...
MUTATION_SCHEDULE: tuple[tuple[str, tuple[object, ...]], ...] = (
    ...
    # Softens the distance-to-probability softmax; see
    # LeadingLambdaClassifier.confidence_temperature and
    # forward.DEFAULT_MODEL_PARAMETERS for the calibration-gap evidence
    # that motivated exploring values above 1.0.
    ("confidence_temperature", (1.0, 1.5, 2.0, 3.0, 4.0)),
    (
