...
class FullLeadingPredictionLambda:
    ...
    def score_jra_race(
        ...
        return self._core.score(odds_snapshots_from_official(snapshots))


# Explicit English/Python naming aliases used from this point forward.
